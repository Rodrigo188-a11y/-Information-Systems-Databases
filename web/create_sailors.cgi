...
print('<h3>Create Sailor Account</h3>')
...
print('<p>Sailor firstname: <input type="text" name="firstname" required/></p>')
print('<p>Sailor surname: <input type="text" name="surname" required/></p>')
